...
class PhoneNumberUtil_SwiftTests: XCTestCase {
  ...
  func testFormatOutOfCountryKeepingAlphaChars() {
    let alphaNumericNumber:PhoneNumber = PhoneNumber()
    ...
    alphaNumericNumber.setCountryCode(0).setNationalNumber(18007493524)
  ...
  func testFormatInOriginalFormat() {
    ...
    // entered.
    let outOfCountryNumberFromAU1 =
        phoneUtil.parseAndKeepRawInput("0012 16502530000", defaultRegion:RegionCode.AU, error:&error)
    ...
    let outOfCountryNumberFromAU2 =
        phoneUtil.parseAndKeepRawInput("0011 16502530000", defaultRegion:RegionCode.AU, error:&error)
  ...
  func testIsPremiumRate() {
    XCTAssertEqual(PhoneNumberUtil.PhoneNumberType.PREMIUM_RATE, phoneUtil.getNumberType(US_PREMIUM))

    let premiumRateNumber:PhoneNumber = PhoneNumber()
    premiumRateNumber.setCountryCode(39).setNationalNumber(892123)
    XCTAssertEqual(PhoneNumberUtil.PhoneNumberType.PREMIUM_RATE, phoneUtil.getNumberType(premiumRateNumber))
    ...
    XCTAssertEqual(PhoneNumberUtil.PhoneNumberType.PREMIUM_RATE, phoneUtil.getNumberType(UNIVERSAL_PREMIUM_RATE))
  }

  func testIsTollFree() {
    let tollFreeNumber:PhoneNumber = PhoneNumber()

    tollFreeNumber.setCountryCode(1).setNationalNumber(8881234567)
    XCTAssertEqual(PhoneNumberUtil.PhoneNumberType.TOLL_FREE, phoneUtil.getNumberType(tollFreeNumber))
    ...
    XCTAssertEqual(PhoneNumberUtil.PhoneNumberType.TOLL_FREE, phoneUtil.getNumberType(INTERNATIONAL_TOLL_FREE))
  }

  func testIsMobile() {
    XCTAssertEqual(PhoneNumberUtil.PhoneNumberType.MOBILE, phoneUtil.getNumberType(BS_MOBILE))
    XCTAssertEqual(PhoneNumberUtil.PhoneNumberType.MOBILE, phoneUtil.getNumberType(GB_MOBILE))
    XCTAssertEqual(PhoneNumberUtil.PhoneNumberType.MOBILE, phoneUtil.getNumberType(IT_MOBILE))
    XCTAssertEqual(PhoneNumberUtil.PhoneNumberType.MOBILE, phoneUtil.getNumberType(AR_MOBILE))

    let mobileNumber:PhoneNumber = PhoneNumber()
    mobileNumber.setCountryCode(49).setNationalNumber(15123456789)
    XCTAssertEqual(PhoneNumberUtil.PhoneNumberType.MOBILE, phoneUtil.getNumberType(mobileNumber))
  }

  func testIsFixedLine() {
    XCTAssertEqual(PhoneNumberUtil.PhoneNumberType.FIXED_LINE, phoneUtil.getNumberType(BS_NUMBER))
    XCTAssertEqual(PhoneNumberUtil.PhoneNumberType.FIXED_LINE, phoneUtil.getNumberType(IT_NUMBER))
    XCTAssertEqual(PhoneNumberUtil.PhoneNumberType.FIXED_LINE, phoneUtil.getNumberType(GB_NUMBER))
    XCTAssertEqual(PhoneNumberUtil.PhoneNumberType.FIXED_LINE, phoneUtil.getNumberType(DE_NUMBER))
  }

  func testIsFixedLineAndMobile() {
    XCTAssertEqual(PhoneNumberUtil.PhoneNumberType.FIXED_LINE_OR_MOBILE, phoneUtil.getNumberType(US_NUMBER))

    let fixedLineAndMobileNumber:PhoneNumber = PhoneNumber().setCountryCode(54).setNationalNumber(1987654321)
    XCTAssertEqual(PhoneNumberUtil.PhoneNumberType.FIXED_LINE_OR_MOBILE, phoneUtil.getNumberType(fixedLineAndMobileNumber))
  }

  func testIsSharedCost() {
    let gbNumber:PhoneNumber = PhoneNumber()
    gbNumber.setCountryCode(44).setNationalNumber(8431231234)
    XCTAssertEqual(PhoneNumberUtil.PhoneNumberType.SHARED_COST, phoneUtil.getNumberType(gbNumber))
  }

  func testIsVoip() {
    let gbNumber:PhoneNumber = PhoneNumber()
    gbNumber.setCountryCode(44).setNationalNumber(5631231234)
    XCTAssertEqual(PhoneNumberUtil.PhoneNumberType.VOIP, phoneUtil.getNumberType(gbNumber))
  }

  func testIsPersonalNumber() {
    let gbNumber:PhoneNumber = PhoneNumber()
    gbNumber.setCountryCode(44).setNationalNumber(7031231234)
    XCTAssertEqual(PhoneNumberUtil.PhoneNumberType.PERSONAL_NUMBER, phoneUtil.getNumberType(gbNumber))
  }

  func testIsUnknown() {
    // Invalid numbers should be of type UNKNOWN.
    XCTAssertEqual(PhoneNumberUtil.PhoneNumberType.UNKNOWN, phoneUtil.getNumberType(US_LOCAL_NUMBER))
  }
  ...
  func testIsValidForRegion() {
    ...
    let reNumber:PhoneNumber = PhoneNumber()
    ...
    let invalidNumber:PhoneNumber = PhoneNumber()
...
//    XCTAssertNil(phoneUtil.getNddPrefixForRegion(nil, stripNonDigits:false))
...
//    XCTAssertFalse(phoneUtil.isNANPACountry(nil))
  ...
  func testIsPossibleNumberWithReason() {
    ...
    XCTAssertEqual(PhoneNumberUtil.ValidationResult.IS_POSSIBLE, phoneUtil.isPossibleNumberWithReason(US_NUMBER))

    XCTAssertEqual(PhoneNumberUtil.ValidationResult.IS_POSSIBLE, phoneUtil.isPossibleNumberWithReason(US_LOCAL_NUMBER))

    XCTAssertEqual(PhoneNumberUtil.ValidationResult.TOO_LONG, phoneUtil.isPossibleNumberWithReason(US_LONG_NUMBER))

    let number:PhoneNumber = PhoneNumber()
    number.setCountryCode(0).setNationalNumber(2530000)
    XCTAssertEqual(PhoneNumberUtil.ValidationResult.INVALID_COUNTRY_CODE, phoneUtil.isPossibleNumberWithReason(number))

    number.clear()
    number.setCountryCode(1).setNationalNumber(253000)
    XCTAssertEqual(PhoneNumberUtil.ValidationResult.TOO_SHORT, phoneUtil.isPossibleNumberWithReason(number))

    number.clear()
    number.setCountryCode(65).setNationalNumber(1234567890)
    XCTAssertEqual(PhoneNumberUtil.ValidationResult.IS_POSSIBLE, phoneUtil.isPossibleNumberWithReason(number))

    XCTAssertEqual(PhoneNumberUtil.ValidationResult.TOO_LONG, phoneUtil.isPossibleNumberWithReason(INTERNATIONAL_TOLL_FREE_TOO_LONG))
  }
  ...
  func testTruncateTooLongNumber() {
    ...
    let tooLongNumber:PhoneNumber = PhoneNumber()
    tooLongNumber.setCountryCode(44).setNationalNumber(80123456780123)
    let validNumber:PhoneNumber = PhoneNumber()
    ...
    let numberWithInvalidPrefix:PhoneNumber = PhoneNumber()
  ...
  func testParseNationalNumber() {
    ...
    let nzNumber:PhoneNumber = PhoneNumber()
    ...
    let shortNumber:PhoneNumber = PhoneNumber()
  ...
  func testParseNumberWithAlphaCharacters() {
    ...
    let premiumNumber:PhoneNumber = PhoneNumber()
  ...
  func testParseNonAscii(){
    ...
    XCTAssertEqual(US_NUMBER, phoneUtil.parse("\\uFF0B1 (650) 253-0000", defaultRegion:RegionCode.SG, error:&error))
    // Using a soft hyphen U+00AD.
    XCTAssertEqual(US_NUMBER, phoneUtil.parse("1 (650) 253\\u00AD-0000", defaultRegion:RegionCode.US, error:&error))
    // The whole number, including punctuation, is here represented in full-width form.
    XCTAssertEqual(US_NUMBER, phoneUtil.parse("\\uFF0B\\uFF11\\u3000\\uFF08\\uFF16\\uFF15\\uFF10\\uFF09" +
                                            "\\u3000\\uFF12\\uFF15\\uFF13\\uFF0D\\uFF10\\uFF10\\uFF10" +
                                            "\\uFF10",
        defaultRegion:RegionCode.SG, error:&error))
    ...
    XCTAssertEqual(US_NUMBER, phoneUtil.parse("\\u1811 \\u1816\\u1815\\u1810 " +
                                            "\\u1812\\u1815\\u1813 \\u1810\\u1810\\u1810\\u1810",
        defaultRegion:RegionCode.US, error:&error))
    XCTAssertNil(error, "Should not have thrown an exception: \(error)")
  }
  ...
  func testParseWithXInNumber() {
    ...
    let arFromUs:PhoneNumber = PhoneNumber()
  ...
  func testParseNumbersMexico() {
    ...
    let mxNumber:PhoneNumber = PhoneNumber()
...
//    XCTAssertNotNil(error, "Null string - but should not throw a null pointer exception.")
  ...
  func testParseExtensions() {
    ...
    let ukNumber:PhoneNumber = PhoneNumber()
    ...
    let usWithExtension:PhoneNumber = PhoneNumber()
    ...
    let usWithTwoExtensionsNumber:PhoneNumber = PhoneNumber()
  ...
  func testParseItalianLeadingZeros() {
    var error:NSError?
    // Test the number "011".
    let oneZero:PhoneNumber = PhoneNumber()
    ...
    // Test the number "001".
    let twoZeros:PhoneNumber = PhoneNumber()
    ...
    let stillTwoZeros:PhoneNumber = PhoneNumber()
    ...
    let threeZeros:PhoneNumber = PhoneNumber()
  ...
  func testCountryWithNoNumberDesc() {
    ...
    let adNumber:PhoneNumber = PhoneNumber()
    ...
    XCTAssertEqual(PhoneNumberUtil.PhoneNumberType.UNKNOWN, phoneUtil.getNumberType(adNumber))
  ...
  func testIsNumberMatchShortNsnMatches() {
    ...
    let italianNumberOne:PhoneNumber = PhoneNumber()
    italianNumberOne.setCountryCode(39).setNationalNumber(1234).setItalianLeadingZero(true)
    let italianNumberTwo:PhoneNumber = PhoneNumber()

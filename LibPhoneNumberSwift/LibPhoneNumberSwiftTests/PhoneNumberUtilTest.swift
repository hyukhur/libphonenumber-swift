...
//    }
    ...
    func testConvertAlphaCharactersInNumber() {
        ...
        XCTAssertEqual(expectedOutput, self.driver.dynamicType.convertAlphaCharactersInNumber(input))
    }

    func testNormaliseRemovePunctuation() {
        let inputNumber:String = "034-56&+#2\u{00AD}34"
        let expectedOutput:String = "03456234"
        XCTAssertEqual(expectedOutput, self.driver.dynamicType.normalize(inputNumber), "Conversion did not correctly remove punctuation")
    }

    func testNormaliseReplaceAlphaCharacters() {
        let inputNumber = "034-I-am-HUNGRY"
        let expectedOutput = "034426486479"
        XCTAssertEqual(expectedOutput, self.driver.dynamicType.normalize(inputNumber), "Conversion did not correctly replace alpha characters")
    }

    func testNormaliseOtherDigits() {
        var inputNumber = "\u{FF12}5\u{0665}"
        var expectedOutput = "255"
        XCTAssertEqual(expectedOutput, self.driver.dynamicType.normalize(inputNumber), "Conversion did not correctly replace non-latin digits")
        // Eastern-Arabic digits.
        inputNumber = "\u{06F5}2\u{06F0}"
        expectedOutput = "520"
        XCTAssertEqual(expectedOutput, self.driver.dynamicType.normalize(inputNumber), "Conversion did not correctly replace non-latin digits")
    }
    ...
    func testNormaliseStripAlphaCharacters() {
        ...
        XCTAssertEqual(expectedOutput, self.driver.dynamicType.normalizeDigitsOnly(inputNumber), "Conversion did not correctly remove alpha character")
    }

//    func testNormaliseStripNonDiallableCharacters() {
//        let inputNumber = "03*4-56&+a#234"
//        let expectedOutput = "03*456+234"
//        XCTAssertEqual(expectedOutput, self.driver.dynamicType.normalizeDiallableCharsOnly(inputNumber), "Conversion did not correctly remove non-diallable characters")
//    }
    ...
    func testIsViablePhoneNumber() {
        XCTAssertFalse(self.driver.dynamicType.isViablePhoneNumber("1"))
        // Only one or two digits before strange non-possible punctuation.
        XCTAssertFalse(self.driver.dynamicType.isViablePhoneNumber("1+1+1"))
        XCTAssertFalse(self.driver.dynamicType.isViablePhoneNumber("80+0"))
        // Two digits is viable.
        XCTAssertTrue(self.driver.dynamicType.isViablePhoneNumber("00"))
        XCTAssertTrue(self.driver.dynamicType.isViablePhoneNumber("111"))
        // Alpha numbers.
        XCTAssertTrue(self.driver.dynamicType.isViablePhoneNumber("0800-4-pizza"))
        XCTAssertTrue(self.driver.dynamicType.isViablePhoneNumber("0800-4-PIZZA"))
        // We need at least three digits before any alpha characters.
        XCTAssertFalse(self.driver.dynamicType.isViablePhoneNumber("08-PIZZA"))
        XCTAssertFalse(self.driver.dynamicType.isViablePhoneNumber("8-PIZZA"))
        XCTAssertFalse(self.driver.dynamicType.isViablePhoneNumber("12. March"))
    }
    ...
    func testExtractPossibleNumber() {
        ...
        XCTAssertEqual("0800-345-600", self.driver.dynamicType.extractPossibleNumber("Tel:0800-345-600"))
        XCTAssertEqual("0800 FOR PIZZA", self.driver.dynamicType.extractPossibleNumber("Tel:0800 FOR PIZZA"))
    ...
    func testMaybeStripNationalPrefix() {
        ...
        XCTAssertEqual(strippedNumber, numberToStrip, "Should have had national prefix stripped.")
        ...
        XCTAssertEqual(strippedNumber, numberToStrip, "Should have had no change - no national prefix present.")
        // Some countries have no national prefix. Repeat test with none specified.
        metadata.setNationalPrefixForParsing("")
        XCTAssertFalse(phoneUtil.maybeStripNationalPrefixAndCarrierCode(numberToStrip, metadata:metadata, carrierCode:""))
        XCTAssertEqual(strippedNumber, numberToStrip, "Should not strip anything with empty national prefix.")
        // If the resultant number doesn't match the national rule, it shouldn't be stripped.
        metadata.setNationalPrefixForParsing("3")
        numberToStrip = "3123"
        strippedNumber = "3123"
        XCTAssertFalse(phoneUtil.maybeStripNationalPrefixAndCarrierCode(numberToStrip, metadata:metadata, carrierCode:""))
        XCTAssertEqual(strippedNumber, numberToStrip, "Should have had no change - after stripping, it wouldn't have matched the national rule.")
        ...
        XCTAssertEqual(strippedNumber, numberToStrip, "Should have had national prefix and carrier code stripped.")
        ...
        XCTAssertTrue(phoneUtil.maybeStripNationalPrefixAndCarrierCode(numberToStrip, metadata:metadata, carrierCode:""))
        XCTAssertEqual(transformedNumber, numberToStrip, "Should transform the 031 to a 5315.")
    }
    ...
    func testParseNationalNumber() {
        ...
        XCTAssertEqual(NZ_NUMBER, phoneUtil.parse("tel:03-331-6005;phone-context=+64;a=%A1", defaultRegion:RegionCode.NZ, error:&error))
        // Test parsing RFC3966 with an ISDN subaddress.
        XCTAssertEqual(NZ_NUMBER, phoneUtil.parse("tel:03-331-6005;isub=12345;phone-context=+64", defaultRegion:RegionCode.NZ, error:&error))
        ...
        XCTAssertEqual(US_LOCAL_NUMBER, phoneUtil.parse("tel:253-0000;isub=12345;phone-context=www.google.com", defaultRegion:RegionCode.US, error:&error))
        ...
        XCTAssertEqual(US_LOCAL_NUMBER, phoneUtil.parse("tel:2530000;isub=12345;phone-context=1-650", defaultRegion:RegionCode.US, error:&error))
        XCTAssertEqual(US_LOCAL_NUMBER, phoneUtil.parse("tel:2530000;isub=12345;phone-context=1234.com", defaultRegion:RegionCode.US, error:&error))
...
//            XCTAssertNotNil(error, "Null string - but should not throw a null pointer exception.")
    ...
    func testIsNumberMatchNsnMatches() {
        ...
        XCTAssertEqual(MatchType.NSN_MATCH, phoneUtil.isNumberMatch("+64 3 331-6005", secondString:"tel:03-331-6005;isub=1234;phone-context=abc.nz"))
    ...
    func testIsNumberMatchShortNsnMatches() {
        ...
        XCTAssertEqual(MatchType.SHORT_NSN_MATCH, phoneUtil.isNumberMatch("+64 3 331-6005", secondString:"tel:331-6005;isub=1234;phone-context=abc.nz"))
        XCTAssertEqual(MatchType.SHORT_NSN_MATCH, phoneUtil.isNumberMatch("+64 3 331-6005", secondString:"tel:331-6005;isub=1234;phone-context=abc.nza=%A1"))
